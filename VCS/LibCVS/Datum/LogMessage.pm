...
A CVS log message, parsed version of info provided in this format:
...
use constant REVISION => '$Header: /cvs/libcvs/Perl/VCS/LibCVS/Datum/LogMessage.pm,v 1.3 2003/06/25 19:07:00 dissent Exp $ ';
